<?php
	...
	mysql_query("INSERT INTO 11CS10059.Sharing (`Id`, `selected_vehicle_id`, `no_of_passengers`, `cost`,`source`, `dest` , `start` , `arrival` , `Owner_Id`) VALUES ('".$s_id."','".$ve_id."','".$a."','".$b."','".$c."','".$d."','".$e."','".$f."','".$_SESSION['Id']."')");
